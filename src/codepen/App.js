...
function App() {
  ...
  const [timerLabel, setTimerLabel] = React.useState(true);
  const getTimerLabel = () => {
    return timerLabel;
  };
  ...
  const [sessionNext, setSessionNext] = React.useState(false);

  const [beep] = React.useState(document.getElementById("beep"));
  ...
  return (
    <div className="App">
      <div className="container app-container bg-blue">
